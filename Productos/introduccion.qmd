...
Por esta razón, algunas de las preguntas más comunes que se plantean son:  ¿Existe alguna forma de prevenir estas desgracias?, ¿cuántos sismos occurren aproximadamente en un año?, ¿hay una hora en donde se originan más temblores? y si es esto correcto, ¿cuál es?

Gracias al Centro De Sismología Internacional (CSI), organización mundial, que se encarga de registrar la magnitud, y la localización de los sismos. Es por elllo que con la labor de esta organización se puede usar esta información recopilada, para hacer innovaciones que podrían prevenir catástrofes graves, por ejemplo, cambiando las estructuras de hormigón de los edificios y las casas de tal forma que sean estables ante las ondas sísmicas, o construir muros anti tsunami para romper las olas que se acercan a la costa.
...
Se puede apreciar, que el 2011 fue el año con la mayor cantidad de sismos en el planeta, esto se puede deber a las replicas que fueron originadas por el terremoto de 9,1 en Japón. Por el contrario, el año con la menor cantidad de sismos es 1965, esto podria explicarse a que en esa epoca no existia aún la tecnologia necesaria para recopilar todos los terremotos que ocurrian en el mundo.
